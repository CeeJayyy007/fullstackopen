...
sequenceDiagram
    ...
    Note over of browser: Submitting a form: The browser does not traditionally send <br/>the user input in the notes field to the server at the click of the Save button but <br/>rather uses the JavaScript code it fetched from the server
